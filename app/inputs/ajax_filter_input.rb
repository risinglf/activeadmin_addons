class AjaxFilterInput < Formtastic::Inputs::StringInput
  ...
  def get_selected_value(display_name)
    relation_name = method.to_s.chomp("_id")
    filter_class_name = @object.klass.reflections[relation_name].class_name
    filter_class = filter_class_name.classify.constantize rescue @object.klass
